...
export class MainHeaderComponent implements OnInit {
   ...
   constructor(public fb: FormBuilder, public authService: AutorizaService, private usuService: UsuariosService) { }
   ...
   playAudio(numCancion: number) { this.authService.playAudio(numCancion); }
}
