...
public class BuildReports {
    ...
    public ByteArrayOutputStream buildPdfReport(Long reporteId) throws JRException, SQLException {
    ...
    public ByteArrayOutputStream buildXlsxReport(Long reporteId) throws JRException, SQLException {
        Reportes reporte = buscarPorId(reporteId);
        try (Connection conn = getConnection()) {
            JasperReport jasperReport = JasperCompileManager.compileReport(
                    new ByteArrayInputStream(reporte.getArchivoJrxml())
    ...
    public ByteArrayOutputStream buildCsvReport(Long reporteId) throws JRException, SQLException {
        Reportes reporte = buscarPorId(reporteId);
        try (Connection conn = getConnection()) {
            JasperReport jasperReport = JasperCompileManager.compileReport(
                    new ByteArrayInputStream(reporte.getArchivoJrxml())
